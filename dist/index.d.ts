 ...
 * ```
 */
declare function useCondition(): ConditionAPI;
/**
...
declare const comparators: {
    ...
    readonly strict: (a: any, b: any) => boolean;
    /** Loose equality comparison (==) */
    readonly loose: (a: any, b: any) => boolean;
    /** Deep object equality using JSON.stringify (note: not suitable for objects with functions) */
    readonly deepEqual: (a: any, b: any) => boolean;
    /** Regular expression matching for strings */
    readonly regex: (value: string, pattern: RegExp) => boolean;
    /** Check if array includes a specific value */
    readonly includes: (array: any[], value: any) => boolean;
    /** Numeric greater than comparison */
    readonly greaterThan: (a: number, b: number) => boolean;
    /** Numeric less than comparison */
    readonly lessThan: (a: number, b: number) => boolean;
    /** Check if value is within a numeric range (inclusive) */
    readonly range: (value: number, min: number, max: number) => boolean;
};
/**
 ...
 * ```
 */
declare const isValidReactNode: (value: any) => value is React.ReactNode;

export { comparators, isValidReactNode, useCondition };
